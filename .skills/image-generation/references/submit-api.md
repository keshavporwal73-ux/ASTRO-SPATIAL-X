...
|-------|-------|
| Method | `POST` |
| URL | `https://app-e91tousmhvk1-api-zYkZzKQJrBdL.gateway.appmedo.com/image-generation/submit` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    "https://app-e91tousmhvk1-api-zYkZzKQJrBdL.gateway.appmedo.com/image-generation/submit",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
