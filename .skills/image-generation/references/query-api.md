...
|-------|-------|
| Method | `POST` |
| URL | `https://app-e91tousmhvk1-api-GYX1lzGw0DQa.gateway.appmedo.com/image-generation/task` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    "https://app-e91tousmhvk1-api-GYX1lzGw0DQa.gateway.appmedo.com/image-generation/task",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
